...
import { ProfileImage } from "./user_components/profileImage"
...
export const Dashboard = () => {
    ...
    const handleCloseMenu = () => {
        ...
        menu.classList.toggle('Dashboard-menu--active')
        const lines = document.querySelectorAll('.Header-button--line')
        lines.forEach(line => { line.classList.toggle('Header-button--active') })
    }

    useEffect(() => {
        const navLink = document.querySelectorAll('.Dashboard-link--nav')
        navLink.forEach(link => { 
            link.addEventListener('click', () => {
                const menu = document.querySelector('.Dashboard-menu')
                menu.classList.remove('Dashboard-menu--active')
            })})
    }, [stringifiedLocation])
    
    return (
        <div className="Dashboard">
            { window.innerWidth < 768 && <button className="Dashboard-menu--close" onClick={handleCloseMenu}>
            ...
            <aside className="Dashboard-menu">
                <div className="Dashboard-menu--group">
                    ...
                    <a href="/" className="Dashboard-link" title='Ir a inicio'>
                        <svg className="Dashboard-logoSvg" width="177" height="70" viewBox="0 0 177 70" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <ul className="Dashboard-list">
                            <div className="Dashboard-nav--group">
                                <li className="Dashboard-item">
                                    <Link to="/dashboard" className={`Dashboard-link--nav ${location === '/dashboard' ? 'active' : ''} ` }>
                                        <span className="Dashboard-item--icon">
                                            <svg className="Dashboard-item--svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 25 26">
                                        ...
                                        <span className="Dashboard-linkTitle">General</span>
                                    </Link>
                                </li>
                                <li className="Dashboard-item">
                                    <Link to="/dashboard/my-diets" className={`Dashboard-link--nav ${location === '/dashboard/my-diets' ? 'active' : ''} ` }>
                                        <span className="Dashboard-item--icon">
                                            <svg className="Dashboard-item--svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 22 27">
                                        ...
                                        <span className="Dashboard-linkTitle">Mis dietas</span>
                                    </Link>
                                </li>
                                <li className="Dashboard-item">
                                    <Link to="/dashboard/my-recipes" className={`Dashboard-link--nav ${location === '/dashboard/my-recipes' ? 'active' : ''} ` }>
                                        <span className="Dashboard-item--icon">
                                            <svg className="Dashboard-item--svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 25 26">
                                        ...
                                        <span className="Dashboard-linkTitle">Mis recetas</span>
                                    </Link>
                                </li>
                                <li className="Dashboard-item">
                                    <Link to="/dashboard/add-recipe" className={`Dashboard-link--nav ${location === '/dashboard/add-recipe' ? 'active' : ''} ` }>
                                        <span className="Dashboard-item--icon">
                                        ...
                                        <span className="Dashboard-linkTitle">Añadir recetas</span>
                                    </Link>
                                </li>
                                <li className="Dashboard-item">
                                    <Link to="/dashboard/favourites" className={`Dashboard-link--nav ${location === '/dashboard/favourites' ? 'active' : ''} ` }>
                                    <span className="Dashboard-item--icon">
                                        <svg className="Dashboard-item--svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 25 26">
                                        ...
                                        <span className="Dashboard-linkTitle">Guardado</span>
                                    </Link>
                                </li>
                            </div>
                            <li className="Dashboard-item">
                                <Link to="/dashboard/user-options" className={`Dashboard-link--nav ${location === '/dashboard/user-options' ? 'active' : ''} ` }>
                                    <span className="Dashboard-item--icon">
                                        <svg className="Dashboard-item--svg" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 25 27" >
                                    ...
                                    <span className="Dashboard-linkTitle">Ajustes de la cuenta</span>
                                </Link>
                            </li>
                        </ul>
                    </nav>
                ...
                { currentUser &&
                    <div className="Dashboard-userContent">
                        <div className="Dashboard-userContent--info">
                            <ProfileImage name={currentUser.username} />
                            <span className="Dashboard-linkTitle">
                                <div className="Dashboard-userWrapper">
                                    <p className="Dashboard-userName">{currentUser.username}</p>
                                    <p className="Dashboard-userEmail">{currentUser.email}</p>
                                </div>
                            </span>
                        </div>
                        <button onClick={handleLogout} className="Dashboard-userLogout">
                            <svg className="Dashboard-item--svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 20">
