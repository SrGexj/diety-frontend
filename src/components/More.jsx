import '../styles/components/_more.scss'
export const More = () => {
    return (
        <section className="More">
            <div className="More-wrapper">
                    <h2 className="More-title">NO ESPERES MÁS PARA EMPEZAR EL CAMBIO, EMPIEZA AHORA </h2>
                    <div className="More-buttonsWrapper">
                        <a href="/recipes" className="Button Button-find Button-find--white">
                        ...
                        <a href="/register" className="Button Button-startNow Button-startNow--dark">
